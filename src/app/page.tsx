  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-zinc-200 dark:bg-zinc-900">
      <div className="text-center w-full border">
        ...
        <button onClick={() => signOut()} className="bg-zinc-50 p-2 px-4 rounded-md font-medium dark:text-white dark:bg-zinc-700 hover:bg-zinc-800 transition-colors ">Log out</button>
      </div>
    </main>
